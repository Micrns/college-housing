...
import { school_data } from "../school-data/school-info";
...
const Rent = () =>{
    ...
    const [iconUniversty, setIconUniversity] = useState("")



    const changeUniversity = (university_school) => {
        ...
        for (let i = 0; i < (school_data.length); i++){
            ...
            if (school_data[i].name === university_school || school_data[i].acronym === university_school){
                
                setIconUniversity(school_data[i].icon);
            };
        }
        // if (school_data[index].name === university_school || school_data[index].acronym === university_school){
        //     setIconUniversity(school_data[index].icon);
        // }
        // else{
        //     setindex(index + 1);
        // }
    ...
    <div className="rent-page">
        ...
        <img className = "school-icon" src={iconUniversty} alt = ""></img>
        ...
        <div className="navbar-1">
            <div className="search-housing">
                ...
                <img src = {searchIcon} alt = "search" onClick={()=>{changeUniversity(university)}}/>
            </div>
